...
var_dump([
    ...
    "time" => time(),
    "Stringtotime+10d" => strtotime("+10days"),
    "date_DATE_BR" => date(DATE_BR),
...
$format = "%d/%m/%Y %Hh%M";
echo "<p>Hoje é". strftime($format) ."</p>";

echo strftime("<p>Hoje é dia %d do %m mês de %Y ás %H horas e %M minutos!</p>");
