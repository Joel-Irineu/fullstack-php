...
$dateBirth = new DateTime("2001-03-26");
$dateStatic = DateTime::createFromFormat(DATE_BR, "26/03/2001 12:00:00");
...
if($diff->invert){
    ...
    echo "<p>Faltam {$diff->days} dias para o seu aniversario.</p>";
}
